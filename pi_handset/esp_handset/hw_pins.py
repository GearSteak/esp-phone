...
DIGI_STEPS_BUTTON_MUTE: ignore tilt pulses this long after a pad press (default `0.55`).
  Mute listens to digi-buttons-inputd (/run/digivice/button-activity) and MCP holds.
"""
